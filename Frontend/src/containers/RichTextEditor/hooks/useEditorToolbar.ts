...
import { $isRootOrShadowRoot, $isTextNode, NodeKey, TextFormatType } from "lexical";
import {
  mergeRegister,
  $findMatchingParent,
...
const useEditorToolbar = ({ editable = true }: UseEditorToolbarProps) => {
