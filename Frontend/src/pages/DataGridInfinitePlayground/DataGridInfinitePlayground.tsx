...
const DataGridPlayground: FC = () => {
    ...
    const [query, setQuery] = useState<PageChangeParams>({pageIndex: 0, pageSize});

    const {allRows, totalRows, isFetching, fetchNextPage} = useInfiniteDataGridPlaygroundAPI({query});
