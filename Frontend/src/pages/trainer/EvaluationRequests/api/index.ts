...
import { AcceptEvaluationRequestBody, AcceptEvaluationRequestResponse, RejectEvaluationRequestBody, RejectEvaluationRequestResponse } from "../types";
...
export const getPendingEvaluations = async (): Promise<PendenigProgressResponse> => {
  ...
  export const acceptEvaluationRequest = (body: AcceptEvaluationRequestBody) => {
    ...
    return axiosInstance
      .patch<AcceptEvaluationRequestResponse>(url, body)
      .then((res) => res.data);
  };
  ...
  export const rejectEvaluationRequest = (body: RejectEvaluationRequestBody) => {
    ...
    return axiosInstance
      .post<RejectEvaluationRequestResponse>(url, body)
      .then((res) => res.data);
  };