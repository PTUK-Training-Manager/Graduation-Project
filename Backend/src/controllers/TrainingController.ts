...
import {fn, col, Op, Sequelize, FindOptions, InferAttributes} from "sequelize";
import {
    TrainingStatusEnum,
    UserRoleEnum,
    TrainingTypeEnum,
...
class TrainingController {
    ...
    getRunningTrainings = async (
        ...
        try {
            ...
            totalItems = await Training.findAll({
                ...options,
                attributes: [[Sequelize.fn('COUNT', Sequelize.col('*')), 'totalItems']],
            });
            ...
            return res.json({
                ...
                pageNumber: page,
                pageSize: size,
                totalItems: totalItems[0].getDataValue('totalItems') || -1,
